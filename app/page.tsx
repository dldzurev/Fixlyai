  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-white dark:from-gray-900 dark:to-gray-800 flex flex-col transition-colors duration-300">
      ...
      <main className="flex-1 flex items-center justify-center px-4 sm:px-6 py-8">
        <div className="w-full max-w-lg sm:max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow-lg shadow-gray-900/5 dark:shadow-gray-900/20 border border-gray-100 dark:border-gray-700 flex flex-col h-[80vh] sm:h-[475px]">
          {/* Messages Area */}
                  ...
                  <div className="w-auto max-w-[75%] sm:max-w-[70%] p-3 sm:p-4 rounded-2xl shadow-md bg-orange-500 text-white">
                    {msg.fileUrl ? (
                      msg.fileType === "image" ? (
                        ...
                        <a href={msg.fileUrl} className="underline text-sm sm:text-base text-white" target="_blank" rel="noreferrer">
                          Download File
                        </a>
                      )
                    ) : (
