    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 relative overflow-hidden transition-colors duration-500">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 py-20">
        ...
        >
          ...
          {/* App Name */}
          <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-gray-900 via-orange-600 to-gray-900 dark:from-white dark:via-orange-400 dark:to-white bg-clip-text text-transparent mb-6 tracking-tight">
            Fixly.ai
          </h1>

          {/* Animated Tagline */}
          <div className="text-xl md:text-2xl lg:text-3xl text-gray-600 dark:text-gray-300 mb-12 font-light leading-relaxed max-w-3xl mx-auto min-h-[4rem] flex items-center justify-center">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group text-center p-8 rounded-2xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-lg shadow-gray-900/5 dark:shadow-gray-900/20 border border-gray-100 dark:border-gray-700 hover:shadow-xl hover:shadow-orange-500/10 transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Instant Diagnosis</h3>
            ...
            <div className="group text-center p-8 rounded-2xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-lg shadow-gray-900/5 dark:shadow-gray-900/20 border border-gray-100 dark:border-gray-700 hover:shadow-xl hover:shadow-orange-500/10 transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Step-by-Step Guidance</h3>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            <div className="group text-center p-8 rounded-2xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-lg shadow-gray-900/5 dark:shadow-gray-900/20 border border-gray-100 dark:border-gray-700 hover:shadow-xl hover:shadow-orange-500/10 transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Safety First</h3>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg shadow-gray-900/5 dark:shadow-gray-900/20 border border-gray-100 dark:border-gray-700 hover:shadow-xl hover:shadow-orange-500/10 transition-all duration-300">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-500 dark:text-gray-400 text-sm">Homeowner</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg shadow-gray-900/5 dark:shadow-gray-900/20 border border-gray-100 dark:border-gray-700 hover:shadow-xl hover:shadow-orange-500/10 transition-all duration-300">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-500 dark:text-gray-400 text-sm">Property Manager</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg shadow-gray-900/5 dark:shadow-gray-900/20 border border-gray-100 dark:border-gray-700 hover:shadow-xl hover:shadow-orange-500/10 transition-all duration-300">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-500 dark:text-gray-400 text-sm">Car Enthusiast</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 px-6 bg-gradient-to-b from-orange-50/30 to-transparent dark:from-orange-950/20 dark:to-transparent">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-8">About Fixly.ai</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            <div className="text-center">
              ...
              <div className="text-gray-600 dark:text-gray-400">Successful Repairs</div>
            </div>
            <div className="text-center">
      ...
      <footer className="py-12 px-6 border-t border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/50 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto text-center">
          <div className="flex items-center justify-center mb-4">
            ...
            <span className="text-xl font-bold text-gray-900 dark:text-white">Fixly.ai</span>
          </div>
